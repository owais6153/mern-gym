                                ...
                                <Col xl="4">
                                    <div className="d-flex">
                                        ...
                                        <div className="pl-3 flex-shrink-1 w-100 d-flex align-items-center">
                                            <div className="title">
                                                <h5 className="card-title font-weight-bold">New Guide Video</h5>
                                                <ul className="breadCrumbList">
                                                    <li><a path="/admin/dashboard" >Home</a></li>
                                                    <li><a path="/admin/Users" >Workouts</a></li>
                        ...
                        <form>
                            <div className="form-row">
                                <FormGroup className="col-lg-6 ">
                                    <Label for="title">Guide Thumbnail</Label>
                                ...
                                <FormGroup className="col-lg-6 tpfupload">
                                    <Label for="title">Guide Video</Label>
                                    <div className="tpfupload">
                                        <div className="fileBg">
                                            <span className="icon">
                                                <svg width="94" height="94" viewBox="0 0 94 94" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <FormGroup className="col-lg-12">
                                    ...
                                    <Input type="textarea"  id="description" placeholder="Type Here"/>
                                </FormGroup>
