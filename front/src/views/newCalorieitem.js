							...
							<Row>
                                <Col xl="4">
                                    <div className="d-flex">
                                        <div>
                                            <Link to="/admin/calorie-calculations">
                                        ...
                                        <div className="pl-3 flex-shrink-1 w-100 d-flex align-items-center">
                                            <div className="title">
                                                <h5 className="card-title font-weight-bold">New Calorie Item</h5>
                    ...
                    <CardBody>
                        <form>
                            <div className="form-row">
                                <div className="col-lg-6">
                                    ...
                                    <Row>
                                        <FormGroup className="col-lg-6">
                                            ...
                                            <Input type="text"  id="quantity" placeholder="800 g"/>
                                        </FormGroup>

                                        <FormGroup className="col-lg-6">
                                            <Label for="title">Calories</Label>
                                            <Input type="text"  id="calories" placeholder="800 g"/>
                                        </FormGroup>
                                    </Row>

                                    <FormGroup>
                                        <Label for="food">Type of Food</Label>
                                        <Input type="select" name="food" id="food" >
                                ...
                                <FormGroup className="col-lg-6 tpfupload">
                                    <Label for="title">Category Thumbnail</Label>
                                    <div className="tpfupload">
                                        <div className="fileBg">
                                            ...
                                            <Input className="form-control-file" type="file" name="uploadVdo" id="uploadVdo" />
                                        </div>
