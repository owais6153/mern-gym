...
import { ContentOfTheDaysCreateAction } from "../../redux/actions/contentOfTheDaysAction";
...
function ContentOfTheDaysCreate (props) {
    ...
    const CreateContentOfTheDaysFormSubmitHandle = (e) => {
      e.preventDefault();
      let formData = new FormData(e.target);
      props.ContentOfTheDaysCreateAction(formData, navigate).then(response => {});
    }
    return (
        <>
            <div className="content">
                              ...
                              <Col xl="4">
                                  <div className="d-flex">
                                      ...
                                      <div className="pl-3 flex-shrink-1 w-100 d-flex align-items-center">
                                          <div className="title">
                                              <h5 className="card-title font-weight-bold">New Content Of The Days</h5>
                ...
                <Card className="guide-card">
                    <CardBody>
                        <form onSubmit={CreateContentOfTheDaysFormSubmitHandle} enctype="multipart/form-data">
                            <div className="form-row">
                                ...
                                <FormGroup className="col-lg-6">
                                    ...
                                    <Input type="number" name="duration" id="duration" placeholder="Enter duration"
                                          invalid={error.duration ? true:false} required onChange={handleChange} 
                                        />
...
const mapDispatchToProps = (dispatch) => ({
  ContentOfTheDaysCreateAction: (data, navigate) => dispatch( ContentOfTheDaysCreateAction(data, navigate) ),
});

export default connect(mapStateToProps, mapDispatchToProps)(ContentOfTheDaysCreate)