						...
						<Card className="card-plain tpf-card">
							...
							<CardBody>
                                <Row>
                                        ...
                                        <div className="tpf-horizontal-card p-3 with-bg my-2">
                                            <Row>
                                                ...
                                                <Col lg="6" className="d-flex align-items-center pl-0">
                                                    <div className="title">
                                                        <h5 className="card-title font-weight-bold">Pre-Workout</h5>
                                                        <p>41 Recipes</p>
                                                    </div>
                                                </Col>

                                                <Col lg="4" className="d-flex justify-content-end">
                                                    <Button color="primary" className="tpf-btn mr-2">
                                                        <i className="fa fa-pen"/>{" "}
                                                    </Button>
                                                    
                                                    <Button color="info" className="tpf-btn">
                                                        <i className="fa fa-plus"/>{" "}
                                                    </Button>
                                                </Col>
                                            </Row>
                                    ...
                                    <Col lg="6">
                                        <div className="tpf-horizontal-card p-3 with-bg my-2">
                                            <Row>
                                                ...
                                                <Col lg="6" className="d-flex align-items-center pl-0">
                                                    <div className="title">
                                                        <h5 className="card-title font-weight-bold">Post-Workout</h5>
                                                        <p>95 Recipes</p>
                                                    </div>
                                                </Col>
                                    ...
                                    <Col lg="6">
                                        <div className="tpf-horizontal-card p-3 with-bg my-3">
                                            <Row>
                                                <Col md="2">
                                                    <figure className="figImage">
                                                        <img src={anime3} alt="..."/>
                                                ...
                                                <Col lg="6" className="d-flex align-items-center pl-0">
                                                    <div className="title">
                                                        <h5 className="card-title font-weight-bold">Vegeterian</h5>
                                                        <p>25 Recipes</p>
                                                    </div>
                                                </Col>
                                    ...
                                    <Col lg="6">
                                        <div className="tpf-horizontal-card p-3 with-bg my-3">
                                            <Row>
                                                ...
                                                <Col lg="6" className="d-flex align-items-center pl-0">
                                                    <div className="title">
                                                        <h5 className="card-title font-weight-bold">Keto Diet</h5>
                                                        <p>14 Recipes</p>
                                                    </div>
                                                </Col>
							...
							<CardHeader>
								<Row>
									<Col md="4">
										<CardTitle tag="h4">
											Recipes Uploads
											<Badge color="info" pill>315</Badge>
										</CardTitle>
										{/* <p className="category">Sort by:</p> */}
										<div className="selectDown">
											<FormGroup>
									...
									<tbody>
										<tr>
											...
											<td className="text-center">
												<Badge color="info" pill>Free</Badge>
											</td>
