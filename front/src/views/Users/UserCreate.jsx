...
import { userCreateAction } from "../../redux/actions/usersAction";
...
function UserCreate (props) {
    ...
    const CreateUserFormSubmitHandle = (e) => {
      e.preventDefault();
      let formData = new FormData(e.target);
      props.userCreateAction(formData, navigate).then(response => {});
    }
    return (
        <>
            <div className="content">
                                  ...
                                  <div className="pl-3 flex-shrink-1 w-100 d-flex align-items-center">
                                      <div className="title">
                                          ...
                                          <ul className="breadCrumbList">
                                              ...
                                              <li><a path="/admin/Users" >Create</a></li>
                                          </ul>
                                      </div>
                                  </div>
                              </div>
                ...
                <Card className="guide-card workout">
                    <CardBody>
                        <form onSubmit={CreateUserFormSubmitHandle}>
                            ...
                            <div className="form-row">
                                    ...
                                    <div className="col-lg-6">
                                        ...
                                        <FormGroup check inline className="form-check-radio">
                                            <Label className="form-check-label">
                                                <Input type="radio" name="is_verified" onChange={handleChange} value={1} invalid={error.is_verified ? true:false}  />
                                                ON
                                        ...
                                        <FormGroup check inline className="form-check-radio">
                                            <Label className="form-check-label">
                                                <Input type="radio" name="is_verified" onChange={handleChange} value={0} invalid={error.is_verified ? true:false} defaultChecked />
                                                OFF
                                                <span className="form-check-sign"></span>
                                            </Label>
                                        </FormGroup>
                                ...
                                <div className="col-lg-12">
                                    <div className="d-flex justify-content-end align-items-center w-100">
                                        <Discart status_field={true} back="users" />
                                        <Button color="default">
                                            Save as Draft
                                            <i className="fa fa-save info"/>{" "}
                                        </Button>
...
const mapDispatchToProps = (dispatch) => ({
  userCreateAction: (data, navigate) => dispatch( userCreateAction(data, navigate) ),
});
