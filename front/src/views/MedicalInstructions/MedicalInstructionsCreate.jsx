...
import { MedicalInstructionsCreateAction } from "../../redux/actions/medicalInstructionsAction";
...
function MedicalInstructions (props) {
    ...
    const CreateFoodTypesFormSubmitHandle = (e) => {
      ...
      props.MedicalInstructionsCreateAction(formData, navigate).then(response => {});
    }
    return (
        <>
                              ...
                              <Col xl="4">
                                  <div className="d-flex">
                                      ...
                                      <div className="pl-3 flex-shrink-1 w-100 d-flex align-items-center">
                                          <div className="title">
                                              <h5 className="card-title font-weight-bold">New Medical Instruction</h5>
                            ...
                            <div className="form-row">
                                ...
                                <FormGroup className="col-lg-6">
                                    ...
                                    <Input type="text" name="medical_condition" id="medical_condition" placeholder="Enter medical condition"
                                          invalid={error.medical_condition ? true:false} required onChange={handleChange} 
                                        />
                                ...
                                <div className="col-lg-6">
                                    ...
                                    <FormGroup check inline className="form-check-radio">
                                        <Label className="form-check-label">
                                            <Input type="radio" name="status" onChange={handleChange} value={1} invalid={error.status ? true:false} />
                                            ON
                                ...
                                <div className="col-lg-12">
                                    <div className="d-flex justify-content-end align-items-center w-100">
                                        <Discart status_field={true} back="medicalInstructions" />
...
const mapDispatchToProps = (dispatch) => ({
  MedicalInstructionsCreateAction: (data, navigate) => dispatch( MedicalInstructionsCreateAction(data, navigate) ),
});
