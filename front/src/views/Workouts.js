                                        ...
                                        <div className="tpf-horizontal-card p-3 with-bg my-2">
                                            <Row>
                                                ...
                                                <Col lg="6" className="d-flex align-items-center pl-0">
                                                    <div className="title">
                                                        <h5 className="card-title font-weight-bold">Gym Workouts</h5>
                                                        <p>41 Guide Videos</p>
                                                    </div>
                                                </Col>
										...
										<div className="filter">
											<div className="searchBox">
												...
												<Button color="link" className="btn-icon btn-round">
													<i className="nc-icon nc-zoom-split1"></i>
												</Button>
											</div>
										...
										<tr>
											...
											<td className="thumbnail">
												<figure className="tpf-list-img">
													<img src={require("../assets/img/anime3.png")} alt="..." />
												</figure>
											</td>
											<td>TPF-00951</td>
											<td>TUESDAY 221018 This triplet</td>
